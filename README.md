...
- Пошаговое создание записи: **событие → мысль → чувства**. На шаге события
  момент задаётся вручную — дата и время до минуты.
- Эмоции с ползунками силы (0–100). Каталог эмоций редактируемый: **свои разделы
  и эмоции** можно создавать в Настройках или прямо во время записи.
